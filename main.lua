...
function kometa.new(isdark, gprojectName, thinProject)
    ...
    local ContainerSize = UDim2.new(0, 885,0, 563)
    ...
    self2.ChangeToggleKey = function(NewKey)
        ...
        kometaData.UpConnection =
            kometa.gs['UserInputService'].InputEnded:Connect(
            function(Input)
                if Input.KeyCode == kometaData.ToggleKey and not typing then
                    ...
                    if toggled then
                        ...
                        pcall(
                            self2.container.TweenPosition,
                            self2.container,
                            UDim2.new(savedposition.Width.Scale, savedposition.Width.Offset, 1.5, 0),
                            'Out',
                            'Sine',
                            0.5,
                            true
    ...
    function self2:Category(name)
        ...
        category.button.MouseEnter:Connect(
            function()
        ...
        category.button.MouseLeave:Connect(
            function()
        ...
        category.button.MouseButton1Down:Connect(
            function()
        ...
        category.button.MouseButton1Up:Connect(
            function()
                kometa.gs['TweenService']:Create(category.button, TweenInfo.new(0.2), {BackgroundTransparency = 1}):Play(
            ...
            uilistlayout.Changed:Connect(
                function()
                    pcall(
                        function()
                            sector.frame.Size =
                                UDim2.new(1, 0, 0, sector.container['UIListLayout'].AbsoluteContentSize.Y + 25)
                            sector.container.Size =
                                UDim2.new(1, 0, 0, sector.container['UIListLayout'].AbsoluteContentSize.Y)
                        end
                    )
                end
            )
            ...
            function sector:Cheat(kind, name, callback, data)
                ...
                if kind then
                    if string.lower(kind) == 'checkbox' or string.lower(kind) == 'toggle' then
                        ...
                        cheat.checkboxbutton.MouseEnter:Connect(
                            function()
                                local lightertheme =
                                    Color3.fromRGB(
                                    (theme.checkbox_outer.R * 255) + 20,
                                    (theme.checkbox_outer.G * 255) + 20,
                                    (theme.checkbox_outer.B * 255) + 20
                                )
                                kometa.gs['TweenService']:Create(
                                    cheat.outerbox,
                                    TweenInfo.new(0.2),
                        ...
                        cheat.checkboxbutton.MouseLeave:Connect(
                            function()
                        ...
                        cheat.checkboxbutton.MouseButton1Down:Connect(
                            function()
                                if cheat.value then
                                    kometa.gs['TweenService']:Create(
                                        cheat.checkboxbutton,
                        ...
                        cheat.checkboxbutton.MouseButton1Up:Connect(
                            function()
                    ...
                    elseif string.lower(kind) == 'color' or string.lower(kind) == 'colorpicker' then
                        ...
                        cheat.hsvbar.MouseButton1Down:Connect(
                            function()
                                ...
                                while uis:IsMouseButtonPressed 'MouseButton1' do
                                    ...
                                    local position =
                                        math.clamp(offset, -sx, cheat.hsvbar.AbsoluteSize.X - sx) /
                                        cheat.hsvbar.AbsoluteSize.X

                                    kometa.gs['TweenService']:Create(
                                        cheat.arrowpreview,
                                        TweenInfo.new(0.1),
                                        {Position = UDim2.new(position, 0, 0.5, -6)}
                                    ):Play()
                        ...
                        cheat.hsvbar.MouseButton2Down:Connect(
                            function()
                                local rs = kometa.gs['RunService']
                                local uis = kometa.gs['UserInputService']
                                local last = cheat.value
                    ...
                    elseif string.lower(kind) == 'dropdown' then
                                ...
                                kometa.gs['TweenService']:Create(
                                    ...
                                    TweenInfo.new(0.2),
                                    {
                                        Size = UDim2.new(
                                            ...
                                            0,
                                            0,
                                            math.clamp(cheat.list['UIListLayout'].AbsoluteContentSize.Y, 0, 150)
                                        ),
                                        Position = UDim2.new(0, 0, 1, 0),
                                        ScrollBarImageTransparency = 0,
                                        BackgroundTransparency = 0
                        ...
                        cheat.dropdown.MouseEnter:Connect(
                            function()
                                kometa.gs['TweenService']:Create(
                                    cheat.selected,
                                    TweenInfo.new(0.1),
                        ...
                        cheat.dropdown.MouseLeave:Connect(
                            function()
                                kometa.gs['TweenService']:Create(
                                    cheat.selected,
                                    TweenInfo.new(0.1),
                        ...
                        cheat.dropdown.MouseButton1Click:Connect(
                            function()
                                cheat.fadelist()
                            end
                        )
                    ...
                    elseif string.lower(kind) == 'textbox' then
                        ...
                        cheat.background.MouseEnter:Connect(
                            function()
                                kometa.gs['TweenService']:Create(
                                    cheat.textbox,
                                    TweenInfo.new(0.1),
                        ...
                        cheat.background.MouseLeave:Connect(
                            function()
                                kometa.gs['TweenService']:Create(
                                    cheat.textbox,
                                    TweenInfo.new(0.1),
                        ...
                        cheat.textbox.FocusLost:Connect(
                            function()
                                typing = false
                    ...
                    elseif string.lower(kind) == 'slider' then
                        ...
                        cheat.sliderbar.MouseButton1Down:Connect(
                            function()
                    ...
                    elseif string.lower(kind) == 'button' then
                        ...
                        cheat.button.MouseEnter:Connect(
                            function()
                                kometa.gs['TweenService']:Create(
                                    cheat.background,
                                    TweenInfo.new(0.2),
                        ...
                        cheat.button.MouseLeave:Connect(
                            function()
                                kometa.gs['TweenService']:Create(
                                    cheat.background,
                                    TweenInfo.new(0.2),
                        ...
                        cheat.button.MouseButton1Down:Connect(
                            function()
                                kometa.gs['TweenService']:Create(
                                    cheat.background,
                                    TweenInfo.new(0.2),
                        ...
                        cheat.button.MouseButton1Up:Connect(
                            function()
                                kometa.gs['TweenService']:Create(
                                    cheat.background,
                                    TweenInfo.new(0.2),
                    ...
                    elseif string.lower(kind) == 'keybind' or string.lower(kind) == 'bind' then
                        ...
                        cheat.button.MouseButton2Down:Connect(
                            function()
                                kometa.gs['TweenService']:Create(
                                    cheat.background,
                                    TweenInfo.new(0.2),
                        ...
                        cheat.button.MouseButton1Up:Connect(
                            function()
                                ...
                                connection =
                                    kometa.gs['UserInputService'].InputBegan:Connect(
                                    function(Input)
                                        if
                                            Input.UserInputType.Name == 'Keyboard' and
                                                Input.KeyCode ~= kometaData.ToggleKey and
                        ...
                        cheat.button.MouseButton2Up:Connect(
                            function()
                                kometa.gs['TweenService']:Create(
                                    cheat.background,
                                    TweenInfo.new(0.2),
